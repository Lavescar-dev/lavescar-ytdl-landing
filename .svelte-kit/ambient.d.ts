...
declare module '$env/static/private' {
	...
	export const QSG_NO_VSYNC: string;
	...
	export const QSG_RHI_BACKEND: string;
	...
	export const QT_QPA_UPDATE_IDLE_TIME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		QT_QPA_UPDATE_IDLE_TIME: string;
